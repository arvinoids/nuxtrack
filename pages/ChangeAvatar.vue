<template>
  <div class="flex flex-col items-center gap-2">
    ...
    <div class="flex flex-row border m-2 p-12 shadow-md w-full gap-10 flex-wrap">
      <div class="flex flex-col items-stretch gap-10">
        ...
        <div class="flex flex-col items-center border p-8">
          <div class="font-semibold mb-2">Upload new avatar</div>
          <div class="badge p-3 m-2">Please keep your avatar to 300x300px or smaller</div>
