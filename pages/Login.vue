<template>
  <div class="flex flex-col justify-center h-auto">
    <div class="flex w-screen items-center justify-center">
      <div class="card w-96 bg-base-100 shadow-xl m-44">
        <div class="card-body">
          <h2 class="card-title text-center">Rotation Tracker</h2>
          <form @submit.prevent="login()" class="flex flex-col gap-2">
            <input
              type="text"
              class="input input-bordered input-sm text-center rounded-full"
